...
| ![AWS IAM User Group Console Screenshot](/aws-project-aws-eks-via-nodegroup/misc/Console-IAM-UserGroup.png) | ![AWS VPC Screenshot](/aws-project-aws-eks-via-nodegroup/misc/Console-VPC.png) | ![AWS EKS Screenshot](/aws-project-aws-eks-via-nodegroup/misc/Wonderful-Metal-Mongoose.png) |
|--|--|--|
